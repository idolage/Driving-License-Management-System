...
if (isset($_POST['btn-upload'])) {
  ...
  if($filename==null){
    $success=2;
    header("Location: renewalprevlicense.php?error=none");
  }
  ...
  if (
    ...
    $sql = "UPDATE user_details_renewal SET previous_license= '$content', license_status = '$photo_status' ,status='Pending' WHERE user_id = '$id';";
    ...
    header("location:renewalprevlicense.php");
    exit();
}
?>
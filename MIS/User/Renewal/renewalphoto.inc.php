...
if (isset($_POST['btn-upload'])) {
  ...
  if($filename==null){
    $success=2;
    header("Location: renewalphoto.php?error=none");
  }
  ...
  if (
    ...
    $sql = "UPDATE user_details_renewal SET user_photo = '$content', photo_status = '$photo_status' ,status='Pending' WHERE user_id = '$id';";
    ...
    header("location:renewalphoto.php");
    exit();
}
?>
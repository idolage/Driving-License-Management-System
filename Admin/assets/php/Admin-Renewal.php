...
<div class="right_col" role="main">
    ...
    <ul class="nav nav-pills nav-fill">
        <li class="nav-item ">
            <a data-toggle="pill" class="nav-link active " href="#menu1" role="tab">New Renewal Applications</a>
        </li>

        <li class="nav-item">
            <a data-toggle="pill" class="nav-link " href="#menu2" role="tab">Approved Renewal Applications</a>
        </li>

        <li class="nav-item">
            <a data-toggle="pill" class="nav-link " href="#menu3" role="tab">Rejected Renewal Applications</a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        <div id="menu2" class="tab-pane fade in" role="tabpanel">
            ...
            ON users.user_id = user_details_renewal.user_id WHERE user_details_renewal.status='Approved'; ";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><button class="btn btn-success bt-sm">Approved</button></td>
                                <td>
                                    <a class="btn btn-primary btn-sm" role="button" href="Admin-Approved-Renewal.php?user_id=<?php echo $row['user_id'] ?>">View Application <i class="fa fa-info-circle" aria-hidden="true"></i></a>
                                </td>
            ...
            <div class="row mt-4">
                ...
                <div class="col-10">
                    ...
                    <table class="table" id="new2Table">
                        ...
                        $sql = "SELECT * FROM users  INNER JOIN user_details_renewal 
            ON users.user_id = user_details_renewal.user_id WHERE user_details_renewal.status='Rejected'; ";
                        $result = mysqli_query($con, $sql);
...
ON users.user_id = user_details_renewal.user_id WHERE user_details_renewal.status='Pending'; ";
                    $result1 = mysqli_query($con, $sql1);

                    if (mysqli_num_rows($result1) > 0) { ?>

                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            Review applications for license renewal
                    ...
                    <?php } else if (mysqli_num_rows($result1) == 0) { ?>
                        ...
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            No new applications for license renewal
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    <table class="table" id="new3Table">
                        ...
                        $sql = "SELECT * FROM users  INNER JOIN user_details_renewal ON users.user_id = user_details_renewal.user_id WHERE user_details_renewal.status='Pending'; ";
                        $result = mysqli_query($con, $sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                    $sql1 = "SELECT user_id , status  FROM user_details_renewal WHERE user_id= '" . $row['user_id'] . "'";
                                    $result1 = mysqli_query($con, $sql1);
                                ...
                                <td style="text-align: center;">
                                        <a class="btn btn-secondary btn-sm" href="Admin-View-Renew-Application.php?user_id=<?php echo $data['user_id'] ?>">View <i class="fa fa-info-circle" aria-hidden="true"></i></a>
                                    </td>
